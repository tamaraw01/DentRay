    ...
    <div className="space-y-4">
      <div className="glass-card rounded-[1.9rem] p-5">
        <div className="relative z-10">
          ...
          <p className="mt-2 text-sm leading-6 text-slate-600">Riwayat skrining Anda.</p>
        </div>
      </div>
      ...
      {sessions.length === 0 ? (
        <Card className="flex items-center gap-5">
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-6 text-slate-600">Mulai skrining pertama untuk menyimpan riwayat.</p>
          </div>
        </Card>
      ) : (
