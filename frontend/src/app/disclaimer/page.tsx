  ...
  return (
    ...
    >
      <Card className="max-w-4xl">
        ...
        <p className="mt-4 text-lg font-semibold leading-8 text-slate-950">DentRay adalah alat skrining visual awal berbasis AI, bukan pengganti pemeriksaan klinis dokter gigi.</p>
