...
export default function AboutPage() {
  return (
    <Section
      ...
      description="Deteksi area visual yang mencurigakan dari satu foto gigi, didukung model AI segmentasi."
    >
      <div className="grid gap-5 md:grid-cols-[1.05fr_0.95fr]">
        <Card className="dark-med-panel">
          <div className="relative z-10">
            ...
            <p className="mt-3 leading-7 text-slate-600">DentRay menganalisis foto gigi dan menandai area yang terdeteksi secara visual menggunakan model AI segmentasi.</p>
          </div>
        </Card>
        <Card>
          ...
          <p className="mt-3 leading-7 text-slate-600">Akurasi hasil bergantung pada kualitas foto dan bukan merupakan diagnosis medis.</p>
        </Card>
      </div>
    </Section>
  );
